...
Revision ID: 1e1259147380
Revises: 
Create Date: 2019-10-03 20:39:29.231465
...
def upgrade():
    ...
    op.create_table('project_job_worktime_history',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('projectJobId', sa.Integer(), nullable=False),
    sa.Column('workTime', sa.Float(), nullable=False),
    sa.Column('comment', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['projectJobId'], ['project_job.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('user')
    op.drop_table('project_job_worktime_history')
